<template lang="pug">
		.ui.container
			div(style="margin-top: 25vh; height: 75vh")
				h1
					i.fas.fa-satellite-dish.fa-5x.mt-12
				h1.ui.enormous.header Marinhos Marinheiros
					
				h2.ui.huge.header Circling the Globo
				
				h3.ui.big.header  Gente da Globo Mentem Muito
